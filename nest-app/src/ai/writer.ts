...
export async function runInquirySkill({ prompt, rows, apiKey, userModel, userProvider, maxTokens }: WriterInput): Promise<InquirySummary> {
...
export async function runReportSkill({ prompt, rows, withChart, apiKey, userModel, userProvider, maxTokens }: WriterInput): Promise<ReportSections> {
